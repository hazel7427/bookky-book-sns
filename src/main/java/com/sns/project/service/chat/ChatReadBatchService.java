...
//    @Transactional
    public void batchUpdateUnreadCounts() {
        ...
        Set<Long> messageIds = stringRedisService.popMultipleFromSet(chatReadQueueKey, 100).stream()
            .map(Long::parseLong)
        ...
        for (Long messageId : messageIds) {
            ...
            int unreadCountOfMessage = Integer.parseInt(stringRedisService.getHashValue(key, field));
